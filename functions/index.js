...
exports.createActivity = functions.firestore
  ...
  .onCreate(event => {
    ...
    return admin
      ...
      .catch(error => {
        return console.log("Error while creating activity", error);
      });
  });
...
exports.cancelActivity = functions.firestore
  ...
  .onUpdate((event, context) => {
    ...
    return admin.firestore
      ...
      .add(activity)
      .then(docRef => {
        return console.log("Activity updated with ID: ", docRef.id);
      })
      .catch(error => {
        return console.log("Error while updating activity", error);
      });
  });
